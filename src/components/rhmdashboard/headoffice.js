...
export const AssesmentCount = ({ assessCountData, 
  assessOverviewData, cummulativeAssess, cumPerformance }) => {
    console.log("cumPerformanceTopFunction", cumPerformance);
  ...
  //   console.log("testCountData", testCountData);
