            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="form-check form-check-inline">
                  ...
                  <select className="form-select w-full" name="residence_type" >
              ...
              <div className={`grid grid-cols-3 gap-4 ${resiToggle}`}>
                <div className="form-group mb-6">
                  <input type="number" name="annual_rent" className="form-control w-full rounded"
                    placeholder="Annual rent" />
                </div>

                <div className="form-group mb-6">
                  <input type="text" name="owner_name" className="form-control w-full rounded"
                    placeholder="Name of owner" />
                </div>
                <div className="form-group mb-6">
                  <input type="text" name="owner_phone" className="form-control w-full rounded"
