...
export const ViewCompletedTable = ({ remittance }) => {
  ...
  return (
    <>
      <Widget>
        <table classNameName="table divide-y">
          <thead>
            <tr classNameName="">
              {fields.map((field, i) => (
                <th key={i} classNameName="">
                  {field.name}
                </th>
              ))}
            </tr>
          </thead>
          <tbody classNameName="divide-y">
            {items.map((remittance, i) => (
              <tr key={i} classNameName="">
                {fields.map((field, j) => (
                  <td key={j} classNameName="">
                    {/* {remittance[field.key]} */}
                    <Link href={`/view/completeddirect/${remittance.assessment_id},${remittance.kgtin}`}>
                      <a classNameName="hover:text-blue-500">
                        {remittance[field.key]}
                      </a>
                    </Link>
                  </td>
...
export const ViewSingleCompletedTable = ({ payerprop, assId }) => {
  ...
  return (
    <>
      <table width='1100' height='1575' align='center' className='print'>
        <tr>
          <td width='1205' height='1569' align='center' valign='top'><table width='1000'>
            <tr>
              <td width='857'>&nbsp;</td>
            ...
            <table width='1100' align='center'>
              <tr>
                ...
                <td width='495' valign='bottom'><div align='center'><span className='style1'>KGIRS</span>
                </div>          <div align='left' className='style10'>
                ...
                <td width='371' valign='bottom'><div align='center' className='style4'>KOGI STATE INTERNAL REVENUE SERVICE</div>
                  ...
                  <p align='center' className='style4'>NOTICE OF ASSESSMENT </p></td>
              </tr>
            </table>
            ...
            <table width='1100'>
              <tr>
                <td width='580' height='1072' valign='top'><table width='580' height='1286' className='tb'>
                  <tr>
                  ...
                  {/* <tr>
              <td className='tb'><div align='right' className='style>
              <td className='tb'> $set_wht </td>      
            </tr>
            <tr>
              <td className='tb'><div align='right' className='style16'>Set off 1st Assessment </div></td>
              <td className='tb'> $set_ass </td>
            </tr> */}
                  <tr>
