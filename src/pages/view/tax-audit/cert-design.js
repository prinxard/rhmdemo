                ...
                <div className="border p-6" ref={componentRef}>
                    ...
                    <div className="my-3">
                        <p className="max-w-md text-sm max-w-prose text-justify">
                            ...
                            January, {new Date(formData.sdate).getFullYear()} to December, {new Date(formData.edate).getFullYear()} have been reconciled, agreed and paid with the details below;
                        </p>
                    </div>
                    <div className="mt-3">
